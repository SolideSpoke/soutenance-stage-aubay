% Soutenance de stage de fin d'études — Aniss Outaleb — EPITA SCIA / Aubay Innov'
...
\subtitle{Détecter et corriger les hallucinations visuelles\\Aubay Innov' --- projet \textit{Explainable Aubay Intelligence}}
...
\input{sections/03_demarche}
\input{sections/04_results_en}
\input{sections/05_industrialisation}
\input{sections/06_recul}
\input{sections/07_conclusion}
\input{sections/08_backups}

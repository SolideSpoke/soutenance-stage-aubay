...
## S02 : Introduction : l'IA se trompe avec aplomb 
...
Un résultat de recherche qui reste dans un notebook ne sert à personne.  La deuxième moitié du stage, c'est NeuralScope : la plateforme qui unifie les trois PoC de l'équipe autour de nos trois principes : comprendre, corriger, piloter. Voici sa page d'accueil. Architecture en monolithe modulaire : une seule base déployable, mais des modules hermétiques par PoC, ce qui a permis à cinq stagiaires d'avancer sans se marcher dessus. FastAPI côté back, React TypeScript côté front, Docker pour la reproductibilité. J'étais responsable du module d'explicabilité de bout en bout.

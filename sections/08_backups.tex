...
% B4 — Heatmap complète
\begin{frame}{B4 : Grid search ASD : cartes de chaleur}
  \centering
  \includegraphics[width=0.8\linewidth,height=0.75\textheight,keepaspectratio]{media/asd_param_heatmap_grid.png}
  \par\vspace{0.1cm}
  {\scriptsize Source : \texttt{sweeps/asd\_params/summary.csv}: $\alpha \in [0.5, 2.0]$, $\lambda \in [1.0, 5.0]$, n $=$ 50 images TextVQA.}
\end{frame}
